...
jQuery(document).ready(function($) {
  ...
  if ($tabs.length) {
    ...
    if (hash !== "" && $("#" + hash + ".js-tabcontent").length !== 0) {
      if (
        $("#label_" + hash + ".js-tablist__link:not([aria-disabled='true'])")
          .length
      ) {
    ...
    $body
      .on("click", ".js-tablist__link:not([aria-disabled='true'])", function(
        event
      ) {
        var $this = $(this),
